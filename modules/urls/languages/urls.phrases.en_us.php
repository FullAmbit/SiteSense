...
function languages_urls_en_us(){
	return array(
		...
		"deleteURLErrorMessageDoesExist" => "The remap cannot be removed. It does exist in the database.",
		"deleteURLErrorMessageDoesNotExist" => "The remap cannot be removed. It does not exist in the database.",
