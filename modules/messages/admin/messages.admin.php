...
*/
function messages_admin_buildContent($data,$db) {
	...
	$target='modules/messages/admin/includes/messages.admin.include.'.$data->action[2].'.php';
...
function messages_admin_content($data) {
